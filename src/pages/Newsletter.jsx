                ...
                <Row className='flex lg:gap-7 lg:px-28 md:px-14 px-6 lg:py-2  w-dvw'>
                    <Col className='text-black lg:pr-8'>
                        <div className="newsletter__content py-12">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl mb-4">Subscribe now to get useful art information.</h2>
                            ...
                            <p className="text-gray-800 text-sm pt-3 md:text-lg">Subscribe now to stay updated with the latest art postings. Be the first to know about exclusive art.</p>
                        </div>
                    </Col>
